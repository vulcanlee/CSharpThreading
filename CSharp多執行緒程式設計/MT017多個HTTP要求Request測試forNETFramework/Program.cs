...
namespace MT017多個HTTP要求Request測試forNETFramework
{
    class Program
    {
        // 使用該 URL 可以調整 ASP.NET 上的執行緒集區設定
        // https://lobworkshop.azurewebsites.net/api/RemoteSource/SetThreadPool/250/250/

        static int RemoteSleepMS = 1200;
        static int MaxTasks = 500;
        ...
        static string APIEndPoint = $"https://localhost:5001/api/RemoteSource/AddASync/8/9/{RemoteSleepMS}";
