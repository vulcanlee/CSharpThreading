...
namespace MT014觀察執行緒集區對於IO執行緒使用情況
{
    class Program
    {
        ...
        public static string APIEndPoint = "https://lobworkshop.azurewebsites.net/api/RemoteSource/AddSync/8/9/5000";
        public static int BusyWorkerThreads = -1, BusyCompletionPortThreads = -1;
